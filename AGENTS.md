...
|---------|--------------------------------------------------------------|---------------------------------------------|
| PDF     | `convert-to-pdf.sh` or `md-to-pdf README.md --stylesheet cv-print.css --launch-options '{"args": ["--no-sandbox"]}' && mv README.pdf Jon_Vallet_CV.pdf` | `npm install -g md-to-pdf`   |
